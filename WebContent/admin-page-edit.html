...
<div class="sb2-2-add-blog sb2-2-1">
                    ...
                    <ul class="nav nav-tabs tab-list">
                        <li class="active"><a data-toggle="tab" href="#home" aria-expanded="true"><i class="fa fa-info" aria-hidden="true"></i> <span>Page Detail</span></a>
                        </li>
                        <li class=""><a data-toggle="tab" href="#menu1" aria-expanded="false"><i class="fa fa-bed" aria-hidden="true"></i> <span>Body</span></a>
                        </li>
										...
										<div class="row">
											<div class="input-field col s12">
												<select>
												  ...
												  <option value="3">Privare(password protect)</option>
												</select>
											</div>
										</div>
                                        <div class="row">
                                            <div class="input-field col s3">
                                                <i class="waves-effect waves-light btn-large waves-input-wrapper ad-page-pre-btn"><a href="index-2.html" target="_blank">Pager Preview</a></i>
                                            </div>
